                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="business_plan" class="form-control" id="" cols="30" rows="3"></textarea>
                                                </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><input type="text" class="form-control"
                                                                        name="service_feature[]" placeholder="Features"></td>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <table class="table table-striped" id="charge">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><input type="text" class="form-control"
                                                                        name="support_charge[]" placeholder="Supoort Charge"></td>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <table class="table table-striped" id="training">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td><input type="text" class="form-control"
                                                                        name="training[]" placeholder="Training"></td>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control mb-2" name="additional_cost_one" placeholder="Additional Cost One">
                                                    <input type="text" class="form-control" name="cost_one" placeholder="Cost One">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control mb-2" name="additional_cost_two" placeholder="Additional Cost Two">
                                                    <input type="text" class="form-control" name="cost_two" placeholder="Cost Two">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control mb-2" name="additional_cost_three" placeholder="Additional Cost Three">
                                                    <input type="text" class="form-control" name="cost_three" placeholder="Cost Three">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control mb-2" name="additional_cost_four" placeholder="Additional Cost Four">
                                                    <input type="text" class="form-control" name="cost_four" placeholder="Cost Four">
                                                </div>
...
<script>
    $(document).on('click', '.add', function() {
        ...
        var html = '';
        html += '<tr>';
        html += '<td><input type="text" name="service_feature[]" placeholder="Features" class="form-control"/></td>';
        html +=
...
<script>
    $(document).on('click', '.charge_add', function() {
        ...
        var html = '';
        html += '<tr>';
        html += '<td><input type="text" name="support_charge[]" placeholder="Support Charge" class="form-control"/></td>';
        html +=
