                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0 font-size-18">Edit Service Package</h4>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('admin.service_package.update', $data->id) }}"
                                    ...
                                    <div class="row">
                                                ...
                                                <select name="service_id" class="form-control" id="" required>
                                                    ...
                                                    @foreach ($services as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id == $data->service_id ? 'selected' : '' }}>
                                                            {{ $item->title }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="technology" value="{{ $data->technology }}"
                                                    class="form-control">
                                            </div>
