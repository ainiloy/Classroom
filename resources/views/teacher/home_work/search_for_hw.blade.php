                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                               ...
                               <div class="row">
                                <div class="col-md-4">
                                    <a href="{{ route('teacher.home_work.index') }}" class="btn btn-primary">All HW</a>
                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="get" action="{{route('teacher.hw.search.result')}}" id="search_result">
