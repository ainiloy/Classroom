...
@section('title')
    <title>Search For Study Material</title>
@endsection
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                               ...
                               <div class="row">
                                <div class="col-md-4">
                                    <a href="{{ route('teacher.study_material.index') }}" class="btn btn-primary">All Srudy Material</a>
                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="get" action="{{route('teacher.sm.search.result')}}" id="search_result">
