                    ...
                    <div class="header-text mb-0">
                        <div class="container">
                            <div class="text-center text-white">
                                <h1 class="text-dark">Homework submit</h1>
                                <ol class="breadcrumb text-center">
                                    <li class="breadcrumb-item"><a href="{{URL::to('/')}}" class="text-dark">Home</a></li>
                                    <li class="breadcrumb-item active text-dark" aria-current="page">Homework submit</li>
                                </ol>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-xl-9 col-lg-12 col-md-12">
						<div class="card mb-0">
							<div class="card-header">
								<h3 class="card-title">Search your homework</h3>
							</div>
							<div class="card-body">
								<div class="ads-tabs">
									                ...
									                <div class="row">
									                    ...
									                    <div class="col-sm-6 col-md-6">
									                        <div class="form-group">
									                            ...
									                            <select class="form-control batch_id" name="batch_id" onchange="getHomework(this.value)" required>
