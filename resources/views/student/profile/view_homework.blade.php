                    ...
                    <div class="header-text mb-0">
                        <div class="container">
                            <div class="text-center text-white">
                                <h1 class="text-dark">Home work</h1>
                                <ol class="breadcrumb text-center">
                                    <li class="breadcrumb-item"><a href="{{URL::to('/')}}" class="text-dark">Home</a></li>
                                    <li class="breadcrumb-item active text-dark" aria-current="page">Home work</li>
                                </ol>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						<div class="card mb-0">
							<div class="card-header">
								<h3 class="card-title">Your Home work - Course: {{ $course->title }} -  Batch: {{ $batch->name }}</h3>
							</div>
							<div class="card-body">
								<div class="ads-tabs">
