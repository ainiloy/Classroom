                        ...
                        <div class="container">
                            <div class="text-center text-white">
                                ...
                                <ol class="breadcrumb text-center">
                                    ...
                                    <li class="breadcrumb-item active text-dark" aria-current="page">Notice</li>
                                </ol>
                            </div>
                        </div>
                    </div>
									                ...
									                <div class="row">
									                    ...
									                    <div class="col-sm-6 col-md-6">
									                        <div class="form-group">
									                            ...
									                            <select class="form-control batch_id" name="batch_id" onchange="getNotice(this.value)" required>
